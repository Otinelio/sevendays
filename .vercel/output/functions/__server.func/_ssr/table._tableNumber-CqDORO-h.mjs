...
import { M as MenuCard } from "./MenuCard-CM-OIi9M.mjs";
import { C as CartDrawer } from "./CartDrawer-B9cPGyEk.mjs";
import { u as useCart } from "./cartStore-WhyZEGLF.mjs";
import { R as Route$5, C as CATEGORY_ORDER, a as CATEGORY_LABELS, d as defaultMenu, f as formatFCFA } from "./router-Cl-UL5Ap.mjs";
import "../_libs/sonner.mjs";
import { S as ShoppingCart, e as CircleCheckBig } from "../_libs/lucide-react.mjs";
import "../_libs/framer-motion.mjs";
import "../_libs/motion-dom.mjs";
import "../_libs/motion-utils.mjs";
import "./whatsapp-BO3V9gRo.mjs";
...
function TablePage() {
  ...
  const sendToKitchen = async () => {
    ...
    setTimeout(() => {
      ...
      setStatus("pending");
      clear();
      setTimeout(() => setStatus("confirmed"), 3e3);
      setTimeout(() => setStatus("delivered"), 8e3);
    }, 500);
  };
