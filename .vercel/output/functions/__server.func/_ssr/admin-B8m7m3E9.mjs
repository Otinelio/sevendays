...
import { C as CATEGORY_ORDER, a as CATEGORY_LABELS, f as formatFCFA, d as defaultMenu } from "./router-Cl-UL5Ap.mjs";
...
function MenuTab() {
  ...
  const toggleSoldOut = async (i) => {
    setItems(items.map((item) => item.id === i.id ? {
      ...item,
...
function OrdersTab() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 max-w-5xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-x-auto", children: [
      ...
      filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream/50 py-4", children: "No orders found." })
    ] })
  ] });
}
...
function PromosTab() {
  ...
  const toggle = async (id, active) => {
    setPromos(promos.map((p) => p.id === id ? {
      ...p,
      active: !active
    } : p));
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      promos.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream/50", children: "No promos added." }),
      promos.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded p-3 flex items-center justify-between", style: {
